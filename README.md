...
[Youtube](https://youtu.be/pOW3mCPCBJA)
...
| Folder     | Contents                                         |
|:-----------|:-------------------------------------------------|
| `./p2p`    | Scripts for the Decentribution Network Layer     |
| `./cmd`    | CLI Scripts for interacting with the blockhain   |
| `./wallet` | Wallet Source code.                              |
| `./APi-go`|  Go Api to interact with Frontend                 |
...
Decentribution only supports **1 fullnode** and **1 mining node** with **infinite number of ordinary node** due to underlining issues with the memorypool and the mining implementation as [explained here]
...
#### How it works (Decentribution context)
...
Decentribuiton achieved 100% decentralization via the use of  [libp2p-go ](https://docs.libp2p.io/) networking libraries used by popular project like [Ipfs](https://ipfs.io/), [filecoin ](https://filecoin.io/) and most recently [Ethereum 2.0](https://github.com/ethereum/eth2.0-specs/pull/1328).


## Demon CLI

This is the official command line for the Decentribution, this command line allows developers to interact with the blockchain network
